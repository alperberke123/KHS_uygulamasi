        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: Text("Hiç aşı olmadıysanız aşağıdaki butona tıklayabilirisniz",style: TextStyle(fontSize: 13,fontWeight: FontWeight.w500),),
            ),
            ElevatedButton(
            ...
            ElevatedButton(
              ...
              onPressed: (){
                Navigator.push(context, MaterialPageRoute(builder: (context) => genelSayfa()));
              },
            ),
            Spacer(),
            Padding(
