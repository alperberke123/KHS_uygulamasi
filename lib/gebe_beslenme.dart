      ...
      body: Padding(
        ...
        child: ListView(
          children: [
            ...
            _buildNutritionTip("Beslenme Tarzı:",
            ...
            _buildNutritionTip("Yemeklerin Yapılma Tarzı:",
            ...
            _buildNutritionTip("Vitamin Mineral Alımı:",
                "Ambalajlı besinlerin son kullanma tarihi ve içeriğine dikkat edilmelidir. İçeriği bilinmeyen besinler gebelik süresinde tüketilmemelidir. Hamilelerde D vitamini yetersizliği, anne karnındaki bebeklerin beyin ve kemik gelişimini olumsuz etkilemekte, doğumsal katarakt hastalığı ve enfeksiyon risklerini de beraberinde getirmektedir. Bütün hamile kadınlar, yazın öğle saatleri dışında günde 10-15 dakika süreyle güneşe çıkmalıdır."),
