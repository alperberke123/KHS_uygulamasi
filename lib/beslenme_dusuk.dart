...
class DusukKiloluHareket extends StatefulWidget {
  const DusukKiloluHareket({super.key});

  @override
  State<DusukKiloluHareket> createState() => _DusukKiloluHareketState();
}

class _DusukKiloluHareketState extends State<DusukKiloluHareket> {
  @override
